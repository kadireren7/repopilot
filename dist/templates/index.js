...
function getDockerfileTemplate(stack, context) {
    if (stack === "Python") {
...
function sanitizeBinaryName(projectName) {
...
function getGitHubActionsTemplate(stack) {
    if (stack === "Python") {
        return `name: CI
...
function getEnvExampleTemplate(stack) {
    if (stack === "Python") {
        return `# Python
PYTHONUNBUFFERED=1
PORT=8000
